...
psql "$TEST_DATABASE_URL" -v ON_ERROR_STOP=1 -f scripts/migrations/286_route_before_departure.sql
psql "$TEST_DATABASE_URL" -v ON_ERROR_STOP=1 -f scripts/tests/286_route_before_departure.sql
