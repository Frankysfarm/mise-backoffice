...
| TL-G2 UI actors | PARTIAL | Real Chromium clicks, screenshot and trace pass for the synthetic driver lifecycle, actual guarded Next dashboard, production BISS Storefront through order success and production Kitchen start/finish. Stable Driver offer selectors exist. Real Driver/Dispatcher production-component execution and canonical full-stack mutations remain open. |
