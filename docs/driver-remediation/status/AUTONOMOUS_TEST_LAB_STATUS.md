...
| TL-G2 UI actors | PARTIAL | Real Chromium clicks, screenshot and trace pass for the synthetic driver lifecycle, actual guarded Next dashboard, production BISS Storefront through retry/order success and production Kitchen through failed/zero-row/CAS retry. Atomic Storefront DB creation passes locally. Real Driver/Dispatcher production-component execution and an HTTP-to-DB full-stack lifecycle remain open. |
