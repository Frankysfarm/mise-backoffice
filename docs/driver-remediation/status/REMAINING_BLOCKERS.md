...
- Aggregate readiness is locally green: T10 exits 0; `test:lab:full:local` exits 0 with 97 pass, 24 explicit opt-in skips and zero failures; the 17 skipped lifecycle cases separately pass 17/17 through their real orchestrator. Remaining browser/soak skips are not claimed as executed evidence.
