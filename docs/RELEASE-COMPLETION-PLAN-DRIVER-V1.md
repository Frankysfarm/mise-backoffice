...
| **NÄCHSTER aktiver Blocker: P1-1** (Realtime ohne Status-Handling/Reconnect) | OFFEN | 30-s-Polling aus P0-2 mildert bereits; verbleibt: Subscribe-Status-Callbacks + Reconnect + mise-Tabelle in DeliveryView. |
