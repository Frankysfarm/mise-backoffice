...
function Badge({ children, tone = 'neutral', icon, style = {} }) {
  ...
  return (
    <span style={{
      ...
      padding: icon ? '5px 11px 5px 9px' : '5px 11px', borderRadius: 9,
...
Object.assign(window, { Btn, IconBtn, Badge, Avatar, Progress, Spinner, Sheet, Screen, Header, CityMap, SAFE_TOP, SAFE_BOTTOM });
