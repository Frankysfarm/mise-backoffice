...
- Branch: `vollausbau/c-a`; finaler Commit siehe Paketreport nach Commit.
- Audit/Änderungen/DB/RLS/Rollback/manuelle Klickwege: `docs/agents/reports/2026-08-31-c-a.md`.
- Gates: TypeScript Exit 0; Vitest 37 Dateien/229 Tests grün; Next Build Exit 0/233 Seiten; gezieltes Playwright Desktop + Mobile 2/2 grün; `git diff --check` Exit 0.
