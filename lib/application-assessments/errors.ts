const messages: Array<[string, string]> = [
  ...
  ['manager is outside candidate location', 'Diese Bewerbung gehört zu einem anderen Standort.'],
  ['assessment template is outside candidate location', 'Test und Bewerbung gehören nicht zum selben Standort.'],
  ...
  ['candidate already has an open assessment', 'Für diese Bewerbung ist bereits ein Test offen.'],
  ['assessment has no published questions', 'Dieser Test enthält noch keine veröffentlichten Fragen.'],
