...
// Phase 5654 — Fahrer-Nachtschicht-Effizienz-Trend-Ranking (Batch 108)
// Verbesserung der Liefereffizienz in Nachtschichten (20–24h UTC) letzter 30 Tage vs. vorherige 30 Tage
...
const MOCK: ApiResponse = {
  fahrer: [
    { fahrer_id: 'f1', fahrer_name: 'Max M.',   rang: 1, effizienz_delta:  0.5, aktuell_touren_pro_std: 2.9, vorher_touren_pro_std: 2.4, rank_delta:  1, ampel: 'gruen', alert_rueckfall: false },
    { fahrer_id: 'f2', fahrer_name: 'Julia F.', rang: 2, effizienz_delta:  0.2, aktuell_touren_pro_std: 2.6, vorher_touren_pro_std: 2.4, rank_delta:  0, ampel: 'gruen', alert_rueckfall: false },
    { fahrer_id: 'f3', fahrer_name: 'Sara K.',  rang: 3, effizienz_delta: -0.1, aktuell_touren_pro_std: 2.2, vorher_touren_pro_std: 2.3, rank_delta: -1, ampel: 'gelb',  alert_rueckfall: false },
    { fahrer_id: 'f4', fahrer_name: 'Tim B.',   rang: 4, effizienz_delta: -0.4, aktuell_touren_pro_std: 1.8, vorher_touren_pro_std: 2.2, rank_delta: -1, ampel: 'rot',   alert_rueckfall: true  },
  ],
  team_avg_delta: 0.05,
  bester_name: 'Max M.',
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Nachtschicht: 20–24 UTC
    const NACHT_START = 20;
    const NACHT_END   = 24;
    ...
    for (const row of data as Array<{
      ...
      if (h < NACHT_START || h >= NACHT_END) continue;
