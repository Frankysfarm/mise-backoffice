...
// Phase 5674 — Fahrer-Spätabend-Effizienz-Trend-Ranking (Batch 113)
// Verbesserung der Liefereffizienz in Spätabendschichten (20–24h UTC) letzter 30 Tage vs. vorherige 30 Tage
...
const MOCK: ApiResponse = {
  fahrer: [
    { fahrer_id: 'f1', fahrer_name: 'Max M.',   rang: 1, effizienz_delta:  0.6, aktuell_touren_pro_std: 2.9, vorher_touren_pro_std: 2.3, rank_delta:  1, ampel: 'gruen', alert_rueckfall: false },
    { fahrer_id: 'f2', fahrer_name: 'Julia F.', rang: 2, effizienz_delta:  0.2, aktuell_touren_pro_std: 2.5, vorher_touren_pro_std: 2.3, rank_delta:  0, ampel: 'gruen', alert_rueckfall: false },
