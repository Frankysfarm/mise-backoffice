...
// Phase 5666 — Fahrer-Mittagsschicht-Effizienz-Trend-Ranking (Batch 111)
// Verbesserung der Liefereffizienz in Mittagsschichten (12–16h UTC) letzter 30 Tage vs. vorherige 30 Tage
...
const MOCK: ApiResponse = {
  fahrer: [
    { fahrer_id: 'f1', fahrer_name: 'Max M.',   rang: 1, effizienz_delta:  0.7, aktuell_touren_pro_std: 3.1, vorher_touren_pro_std: 2.4, rank_delta:  1, ampel: 'gruen', alert_rueckfall: false },
    { fahrer_id: 'f2', fahrer_name: 'Julia F.', rang: 2, effizienz_delta:  0.3, aktuell_touren_pro_std: 2.7, vorher_touren_pro_std: 2.4, rank_delta:  0, ampel: 'gruen', alert_rueckfall: false },
    { fahrer_id: 'f3', fahrer_name: 'Sara K.',  rang: 3, effizienz_delta: -0.1, aktuell_touren_pro_std: 2.3, vorher_touren_pro_std: 2.4, rank_delta: -1, ampel: 'gelb',  alert_rueckfall: false },
    { fahrer_id: 'f4', fahrer_name: 'Tim B.',   rang: 4, effizienz_delta: -0.5, aktuell_touren_pro_std: 1.9, vorher_touren_pro_std: 2.4, rank_delta: -1, ampel: 'rot',   alert_rueckfall: true  },
  ],
  team_avg_delta: 0.10,
  bester_name: 'Max M.',
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Mittagsschicht: 12–16h UTC
    const MITTAG_START = 12;
    const MITTAG_END   = 16;
    ...
    for (const row of data as Array<{
      ...
      if (h < MITTAG_START || h >= MITTAG_END) continue;
