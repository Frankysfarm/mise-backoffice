...
// Phase 5638 — Fahrer-Abendschicht-Effizienz-Trend-Ranking (Batch 104)
// Verbesserung der Liefereffizienz in Abendschichten (17–22h UTC) letzter 30 Tage vs. vorherige 30 Tage
...
const MOCK: ApiResponse = {
  fahrer: [
    { fahrer_id: 'f1', fahrer_name: 'Max M.',   rang: 1, effizienz_delta:  0.6, aktuell_touren_pro_std: 3.2, vorher_touren_pro_std: 2.6, rank_delta:  1, ampel: 'gruen', alert_rueckfall: false },
    { fahrer_id: 'f2', fahrer_name: 'Julia F.', rang: 2, effizienz_delta:  0.3, aktuell_touren_pro_std: 2.9, vorher_touren_pro_std: 2.6, rank_delta:  0, ampel: 'gruen', alert_rueckfall: false },
    { fahrer_id: 'f3', fahrer_name: 'Sara K.',  rang: 3, effizienz_delta: -0.1, aktuell_touren_pro_std: 2.4, vorher_touren_pro_std: 2.5, rank_delta: -1, ampel: 'gelb',  alert_rueckfall: false },
    { fahrer_id: 'f4', fahrer_name: 'Tim B.',   rang: 4, effizienz_delta: -0.5, aktuell_touren_pro_std: 2.0, vorher_touren_pro_std: 2.5, rank_delta: -1, ampel: 'rot',   alert_rueckfall: true  },
  ],
    ...
    if (driverId) {
      ...
      if (me) {
        return NextResponse.json({
          fahrer: rows,
          team_avg_delta: Math.round(rows.reduce((s, r) => s + r.effizienz_delta, 0) / gesamt * 100) / 100,
