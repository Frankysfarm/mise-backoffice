    ...
    <>
      ...
      */}
      ...
      <SectionGroup title="Live-Betrieb">
        ...
        <SectionCard href="/delivery/location-health" icon={<HeartPulse className="h-5 w-5" />} title="Standort-Gesundheits-Score"
          subtitle="Aggregierter Score (0–100) · Pünktlichkeit, Fahrerverfügbarkeit, Stornoquote, Kundenzufriedenheit · Note A–F · Trend" cta="Score ansehen" highlight />
        ...
        <SectionCard href="/delivery/notifications" icon={<BellDot className="h-5 w-5" />} title="Notification Center"
      ...
      <SectionGroup title="KI-Tools">
        ...
        <SectionCard href="/delivery/delivery-promise" icon={<Target className="h-5 w-5" />} title="Lieferversprechen-Engine"
      ...
      <SectionGroup title="Finanzen & Vergütung">
        ...
        <SectionCard href="/delivery/score-bonus-triggers" icon={<Target className="h-5 w-5" />} title="Score-Bonus-Trigger"
