...
export function DispatchPhase3236StoppBewertungRankingBoard({ locationId }: { locationId: string | null }) {
    ...
    <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4 shadow-sm space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-sm text-gray-800 dark:text-gray-100">Stopp-Bewertungs-Ranking</span>
        </div>
        {data.alert_count > 0 && (
      ...
      {/* Ranking-Liste — absteigend Rang 1 = höchster Score */}
          ...
          <div key={f.fahrer_id} className="flex items-center gap-2">
            ...
            <div className="w-20 h-1.5 rounded-full bg-gray-100 dark:bg-gray-700 overflow-hidden">
              <div
                ...
                style={{ width: `${Math.round((f.avg_score / 5) * 100)}%` }}
              />
            </div>
