...
export function DispatchPhase3984ReaktionszeitBoard({ locationId }: { locationId: string | null }) {
  ...
  // ascending: lowest avg_min = Rang 1 = fastest = best
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <div className="bg-gray-50 rounded-lg p-2 text-center">
          ...
          <div className="text-lg font-black text-gray-700">{data.team_avg_min} min</div>
