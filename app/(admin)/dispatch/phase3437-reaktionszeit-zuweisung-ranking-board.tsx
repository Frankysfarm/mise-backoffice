...
export function DispatchPhase3437ReaktionszeitZuweisungRankingBoard({ locationId }: { locationId: string | null }) {
  ...
  const maxMin = Math.max(...data.fahrer.map(f => f.reaktionszeit_min), 1);
    ...
    <div className="border rounded-lg bg-white dark:bg-gray-900 shadow-sm mb-3">
      ...
      >
        <span className="flex items-center gap-2 font-semibold text-sm">
          ...
          Reaktionszeit auf Zuweisung Ranking
          {data.alert_count > 0 && (
              ...
              <div key={f.fahrer_id} className="flex items-center gap-2">
                ...
                <div className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-full h-2 relative">
                  <div
                    ...
                    style={{ width: `${(f.reaktionszeit_min / maxMin) * 100}%` }}
                  />
                </div>
