...
export function DispatchPhase3517KmProStoppRankingBoard({ locationId }: { locationId: string | null }) {
  ...
  const maxKm = Math.max(...data.fahrer.map(f => f.km_pro_stopp), 0.1);
              ...
              <div key={f.fahrer_id} className="flex items-center gap-2">
                ...
                <div className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-full h-2 relative">
                  <div
                    ...
                    style={{ width: `${(f.km_pro_stopp / maxKm) * 100}%` }}
                  />
                </div>
