...
const MOCK: ApiData = {
  fahrer: [
    { fahrer_id: 'f1', fahrer_name: 'Julia F.', auslastung_pct: 91.5, trend: 'steigend', trend_delta:  5.2, ampel: 'gruen', alert_gering: false },
    { fahrer_id: 'f2', fahrer_name: 'Max M.',   auslastung_pct: 84.7, trend: 'stabil',   trend_delta:  0.3, ampel: 'gruen', alert_gering: false },
    { fahrer_id: 'f3', fahrer_name: 'Sara K.',  auslastung_pct: 72.3, trend: 'fallend',  trend_delta: -4.1, ampel: 'gelb',  alert_gering: false },
    { fahrer_id: 'f4', fahrer_name: 'Tim B.',   auslastung_pct: 55.0, trend: 'fallend',  trend_delta: -8.0, ampel: 'rot',   alert_gering: true  },
  ],
  team_avg_pct: 75.9,
  alert_count: 1,
};

export function DispatchPhase3031FruehschichtAuslastungBoard({ locationId }: { locationId: string | null }) {
    ...
    <div className={`rounded-xl border shadow-sm mb-4 overflow-hidden ${hasAlert ? 'border-red-300' : 'border-gray-200'} bg-white dark:bg-gray-900`}>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-sm text-gray-800 dark:text-gray-100">Frühschicht-Auslastung (06–14 Uhr)</span>
