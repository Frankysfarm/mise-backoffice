...
export function DispatchPhase3512StoppsProSchichtRankingBoard({ locationId }: { locationId: string | null }) {
  ...
  const maxStopps = Math.max(...data.fahrer.map(f => f.stopps_pro_schicht), 1);
        ...
        <div className="px-3 pb-3 space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2 py-1">
            ...
            <div className="text-center">
              ...
              <div className="text-xs font-semibold">{data.team_avg}/Schicht</div>
            </div>
            <div className="text-center">
              ...
              <div key={f.fahrer_id} className="flex items-center gap-2">
                ...
                <div className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-full h-2 relative">
                  <div
                    ...
                    style={{ width: `${(f.stopps_pro_schicht / maxStopps) * 100}%` }}
                  />
                </div>
