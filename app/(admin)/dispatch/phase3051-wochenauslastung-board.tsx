...
const MOCK: ApiData = {
  fahrer: [
    { fahrer_id: 'f1', fahrer_name: 'Julia F.', auslastung_pct: 88.3, trend: 'steigend', trend_delta:  3.1, ampel: 'gruen', alert_gering: false },
    { fahrer_id: 'f2', fahrer_name: 'Max M.',   auslastung_pct: 78.2, trend: 'stabil',   trend_delta:  0.4, ampel: 'gruen', alert_gering: false },
    { fahrer_id: 'f3', fahrer_name: 'Sara K.',  auslastung_pct: 65.4, trend: 'fallend',  trend_delta: -2.8, ampel: 'gelb',  alert_gering: false },
    { fahrer_id: 'f4', fahrer_name: 'Tim B.',   auslastung_pct: 45.7, trend: 'fallend',  trend_delta: -5.2, ampel: 'rot',   alert_gering: true  },
  ],
  team_avg_pct: 69.4,
  alert_count: 1,
};

export function DispatchPhase3051WochenauslastungBoard({ locationId }: { locationId: string | null }) {
    ...
    <div className={`rounded-xl border shadow-sm mb-4 overflow-hidden ${hasAlert ? 'border-red-300' : 'border-gray-200'} bg-white dark:bg-gray-900`}>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-sm text-gray-800 dark:text-gray-100">Wochenauslastung (Mo–So)</span>
