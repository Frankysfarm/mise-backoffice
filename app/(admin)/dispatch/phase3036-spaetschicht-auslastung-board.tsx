...
const MOCK: ApiData = {
  fahrer: [
    { fahrer_id: 'f1', fahrer_name: 'Max M.',   auslastung_pct: 88.0, trend: 'steigend', trend_delta:  6.0, ampel: 'gruen', alert_gering: false },
    { fahrer_id: 'f2', fahrer_name: 'Julia F.', auslastung_pct: 82.1, trend: 'stabil',   trend_delta:  0.1, ampel: 'gruen', alert_gering: false },
    { fahrer_id: 'f3', fahrer_name: 'Sara K.',  auslastung_pct: 74.5, trend: 'fallend',  trend_delta: -5.5, ampel: 'gelb',  alert_gering: false },
    { fahrer_id: 'f4', fahrer_name: 'Tim B.',   auslastung_pct: 57.2, trend: 'fallend',  trend_delta: -7.2, ampel: 'rot',   alert_gering: true  },
  ],
  team_avg_pct: 75.5,
  alert_count: 1,
};

export function DispatchPhase3036SpaetschichtAuslastungBoard({ locationId }: { locationId: string | null }) {
    ...
    <div className={`rounded-xl border shadow-sm mb-4 overflow-hidden ${hasAlert ? 'border-red-300' : 'border-gray-200'} bg-white dark:bg-gray-900`}>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-sm text-gray-800 dark:text-gray-100">Spätschicht-Auslastung (14–22 Uhr)</span>
