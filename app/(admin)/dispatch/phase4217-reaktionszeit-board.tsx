...
export function DispatchPhase4217ReaktionszeitBoard({ locationId }: Props) {
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        <div className="bg-purple-50 rounded-lg p-2">
          <p className="text-[10px] text-purple-600 font-medium">Schnellste</p>
          <p className="text-sm font-bold text-purple-700">{bester?.avg_min} min</p>
          <p className="text-[10px] text-purple-500 truncate">{data.schnellster_name}</p>
        </div>
        <div className="bg-gray-50 rounded-lg p-2">
          ...
          <p className="text-[10px] text-gray-400">Ziel ≤{data.ziel_min} min</p>
        </div>
        <div className="bg-red-50 rounded-lg p-2">
          <p className="text-[10px] text-red-500 font-medium">Langsamste</p>
          <p className="text-sm font-bold text-red-600">{letzter?.avg_min} min</p>
