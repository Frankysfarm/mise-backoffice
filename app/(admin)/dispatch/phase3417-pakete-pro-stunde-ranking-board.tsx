...
export function DispatchPhase3417PaketeProStundeRankingBoard({ locationId }: { locationId: string | null }) {
    ...
    <div className="border rounded-lg bg-white dark:bg-gray-900 shadow-sm mb-3">
      ...
      >
        <span className="flex items-center gap-2 font-semibold text-sm">
          ...
          Pakete/h Ranking
          {data.alert_count > 0 && (
            <span className="ml-1 px-1.5 py-0.5 rounded bg-orange-100 text-orange-700 text-xs font-bold">
              {data.alert_count} ⚠
            </span>
          )}
        </span>
      ...
      {open && (
        <div className="px-3 pb-3 space-y-2">
          {data.alert_count > 0 && (
            <div className="flex items-center gap-1.5 p-2 rounded bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-400 text-xs border border-orange-200">
          ...
          <div className="grid grid-cols-3 gap-2 py-1">
            ...
            <div className="text-center">
              ...
              <div className="text-xs font-semibold">{data.team_avg}/h</div>
            </div>
            <div className="text-center">
              ...
              <div key={f.fahrer_id} className="flex items-center gap-2">
                ...
                <div className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-full h-2 relative">
                  <div
                    ...
                    style={{ width: `${(f.pakete_pro_stunde / maxRate) * 100}%` }}
                  />
                </div>
