...
export function DispatchPhase5123AbschlussquoteBoard({ locationId }: { locationId: string | null }) {
    ...
    <div className="rounded-2xl border border-green-700 bg-green-950/40 overflow-hidden mb-4">
      <div className="px-4 py-3 flex items-center justify-between border-b border-green-700/50 bg-green-900/20">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-green-200">Touren-Abschlussquote je Fahrer (letzte 30 Tage)</span>
        </div>
        {data.alert_count > 0 && (
      ...
      <div className="grid grid-cols-3 divide-x divide-green-800/40 border-b border-green-700/30">
        <div className="px-3 py-2 text-center">
          ...
          <div className="text-sm font-bold text-green-300">{bester?.quote_pct ?? '–'}%</div>
        ...
        <div className="px-3 py-2 text-center">
          ...
          <div className="text-sm font-bold text-green-200">{data.team_avg_quote}%</div>
          <div className="text-[10px] text-gray-500">Abschlussquote</div>
        </div>
        <div className="px-3 py-2 text-center">
          <div className="text-[10px] text-gray-500 mb-0.5">Niedrigste</div>
          <div className="text-sm font-bold text-gray-400">{letzter?.quote_pct ?? '–'}%</div>
