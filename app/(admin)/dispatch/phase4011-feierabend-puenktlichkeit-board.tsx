...
export function DispatchPhase4011FeierabendPuenktlichkeitBoard({ locationId }: Props) {
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-gray-900">Feierabend-Pünktlichkeit</span>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="bg-emerald-50 rounded-lg p-2 text-center">
          ...
          <div className="text-[10px] text-emerald-500">{bester?.feierabend_pct ?? 0}%</div>
        </div>
        <div className="bg-gray-50 rounded-lg p-2 text-center">
          ...
          <div className="text-[10px] text-gray-400">Feierabend</div>
        </div>
        <div className="bg-red-50 rounded-lg p-2 text-center">
          ...
          <div className="text-[10px] text-red-400">{niedrigster?.feierabend_pct ?? 0}%</div>
        </div>
      </div>
