...
export function DispatchPhase4202StoppdauerBoard({ locationId }: Props) {
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-gray-900">Stopp-Verweildauer</span>
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        <div className="bg-orange-50 rounded-lg p-2">
          <p className="text-[10px] text-orange-600 font-medium">Schnellster</p>
          <p className="text-sm font-bold text-orange-700">{bester?.avg_sec} s</p>
        ...
        <div className="bg-gray-50 rounded-lg p-2">
          ...
          <p className="text-sm font-bold text-gray-700">{data.team_avg_sec} s</p>
          <p className="text-[10px] text-gray-400">Stoppdauer</p>
        </div>
        <div className="bg-red-50 rounded-lg p-2">
          <p className="text-[10px] text-red-500 font-medium">Längste</p>
          <p className="text-sm font-bold text-red-600">{letzter?.avg_sec} s</p>
          ...
          return (
            <div key={f.fahrer_id} className="space-y-0.5">
              <div className="flex items-center gap-1.5">
                ...
                <span className={`text-xs font-bold ${tColor}`}>{f.avg_sec} s</span>
              </div>
