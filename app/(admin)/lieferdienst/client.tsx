...
import { LieferdienstPhase2655StatistikTagesvergleichDashboard } from './phase2655-statistiken-tagesvergleich-dashboard';
import { LieferdienstPhase2660StatistikIntelligenceDashboard } from './phase2660-statistiken-intelligence-dashboard';
...
import { LieferdienstPhase5531StatistikenDashboardV56 } from './phase5531-statistiken-dashboard-v56';
          ...
          {currentView === 'stats' && (
            <div className="p-6 space-y-6">
              ...
              <>
                ...
                {/* Phase 2130: Smart-Statistik-Hub — 6-KPI-Kacheln heute; Stunden-Balken; Delta vs. gestern; Ampel; 5-Min-Polling */}
                ...
                {/* Phase 2235: Statistik-Dashboard — 4-KPI-Grid + Stundenchart + Storno-Rate; Heute ab 0 Uhr; 5-Min-Polling */}
                ...
                {/* Phase 2597: Statistiken Dashboard Ultimate — Live KPIs Umsatz/Lieferungen/Ø-Lieferzeit/Fahrer/Storno; Vorwoche-Vergleich; Trend-Pfeile; 60-Sek-Polling */}
                ...
                {/* Phase 2620: Statistiken Echtzeit Final Cockpit — 8 KPI-Kacheln Ampel+Trend; Stunden-BarChart umschaltbar; Zonen-Ranking; Top-5-Fahrer; Alert-Strip; 3-Min-Polling */}
                ...
                {/* Phase 2655: Statistiken Tagesvergleich Dashboard — 8 KPI-Kacheln Ampel+Trend Heute vs Gestern+Δ%; BarChart Stundenverlauf 2-Modi umschaltbar Heute(lila)/Gestern(grau)/Jetzt(blau); Alert-Strip; 1-Min-Polling */}
                <LieferdienstPhase2655StatistikTagesvergleichDashboard locationId={locationId ?? null} />
                {/* Phase 2660: Statistiken Intelligence Dashboard — 8 KPI-Kacheln Ampel+Trend+Ziel; Stunden-BarChart 2-Modi Bestellungen/Umsatz; Jetzt-Stunde blau hervorgehoben; Alert-Strip; 2-Min-Polling */}
                <LieferdienstPhase2660StatistikIntelligenceDashboard locationId={locationId ?? null} />
                {/* Phase 2665: Statistiken Final Master Hub — 6-KPI-Grid Ampel+Trend vs. Gestern; Stundenverlauf-BarChart (letzte 12h, Jetzt-Stunde matcha); Alert-Strip Rot-KPIs; 1-Min-Polling */}
                ...
                {/* Phase 4615: Statistiken Live Dashboard — BarChart2 indigo; Gesamt-Score-Balken; Alert-Strip; 8-KPI-Grid Ampel+Δ%+Ziel; Stundenverlauf BarChart; Top-3-Fahrer; 60-Sek-Polling; Mock-Fallback */}
                ...
                {/* Phase 5075: Statistiken-Performance-Hub — 6-KPI-Grid Ampel+Δ%+Ziel; Fahrer-Vergleich; Zonen-ROI; 45-Sek-Polling */}
                ...
                {/* Phase 5078: Produktivitäts-Panel — Zap amber; Ranking Pünktlichkeit+Stopps/h+Bewertung; Score-Bar farbkodiert; TrendIcon; Alert <50; 60-Sek-Polling */}
                ...
                {/* Phase 5120: Statistiken-Dashboard V31 — 8-KPI-Grid Ampel+Δ; 4-Tab-Nav Stunden/Fahrer/Zonen/Woche; Top-3-Fahrer-Ranking; Zonen-SLA-Matrix; Wochen-LineChart; 60-Sek-Polling */}
                <LieferdienstPhase5120StatistikenDashboardV31 locationId={locationId ?? null} />
                {/* Phase 5137: Statistiken-Dashboard V32 — 9-KPI-Grid 3-spaltig Ampel+Icon+Δ+Ziel; 4-Tab-Nav; Wochen-LineChart; Top-3-Fahrer; Zonen-SLA; 60-Sek-Polling */}
                ...
                {/* Phase 5142: Statistiken-Dashboard V35 — Qualitäts-Score+Fortschrittsbalken; 9-KPI inkl. Qualität; 5-Tab-Nav Stunden/Fahrer/Zonen/Woche/Alerts; Live-Alerts-Tab mit kritisch/warn/info; km-Anzeige Fahrer; 60-Sek-Polling */}
                ...
                {/* Phase 5145: Statistiken-Dashboard V38 — Dual-Gauge Effizienz+Qualität; 9-KPI-Grid; 5-Tab Überblick/Stunden/Fahrer/Zonen/Prognose; Kapazitäts-Prognose-Chart; Fahrer-Tier+Trend; 60-Sek-Polling */}
                <LieferdienstPhase5145StatistikenDashboardV38 locationId={locationId ?? null} />
                {/* Phase 5146: Statistiken-Dashboard V39 — Dual-Score Effizienz+Pünktlichkeit; Rentabilitäts-Trend-Chart Ertrag vs Kosten; Schicht-Pünktlichkeit-Tab; Zonen-SLA; Alert-Ampel; 60-Sek-Polling */}
                ...
                {/* Phase 5535: Statistiken-Dashboard V57 — Schicht-ROI-Analyse, Personalkosten-Benchmark, Touren-Rendite-Heatmap, Wellbeing-Trend 7 Schichten, 18-KPI-Grid 4-spaltig, 13-Tab-Nav */}
                <LieferdienstPhase5535StatistikenDashboardV57 locationId={locationId ?? null} />
                {/* Phase 5545: Statistiken-Dashboard V59 — 20-KPI-Grid, Schicht-Gesundheits-Score, Peak-Prognose-Ampel, Loyalitäts-Matrix */}
                ...
                <LieferdienstPhase5035StatistikenDashboardV25 locationId={locationId ?? null} />
...
// Phase 2736 — Statistiken Live-Master (BarChart3-Icon lila; 10-KPI-Kacheln 2-spaltig Ampel+Δ%+Ziel+Trend; Gesamt-Score 0–100; Insight-Tipp; Stundenverlauf-BarChart 2-Modi Jetzt-Stunde lila; Alert-Strip rot-KPIs; Mock-Fallback; 60-Sek-Polling)
...
// Phase 4705 — Statistiken Live Board Ultra (8 KPI-Kacheln Ampel+Δ%+Ziel; Score-Balken; Alert-Strip; Stundenverlauf BarChart 2-Modi; Top-3-Fahrer Score-Balken+Trinkgeld; 60-Sek-Polling; Mock-Fallback)
...
// Phase 4946 — Statistiken-Dashboard V21 (BarChart2 emerald; CO₂-Banner lime Schicht-Gesamt+Ziel-Balken; 8-KPI-Grid Ampel+Icon+Δ%; Schicht-Vergleich Mittag/Nachmittag/Abend Score+Touren+Umsatz; Stundenverlauf BarChart 3-Modi Bestellungen/Umsatz/Pünktlichkeit Jetzt-Stunde violet; Zonen-Performance SLA-Balken+Avg+Umsatz+Trend; Top-3-Fahrer 🥇🥈🥉+Score+Touren+Trinkgeld+CO₂; Alert-Strip rot-KPIs; 60-Sek-Polling; Mock-Fallback)
export { LieferdienstPhase4946StatistikenDashboardV21 } from './phase4946-statistiken-dashboard-v21';

// Phase 5000 — Statistiken-Dashboard V21b (BarChart2 indigo; Score+Ziel-Fortschrittsbalken; Alert-Strip; 8-KPI-Grid 4-spaltig Ampel+Trend+Ziel-Balken; Stundenverlauf BarChart 3-Modi umschaltbar Jetzt-Stunde violet; Schichtvergleich 3-Kacheln; Top-3-Fahrer 🥇🥈🥉+Score+Touren+Trinkgeld; Zonen-SLA-Balken; 60-Sek-Polling; Mock-Fallback)
export { LieferdienstPhase5000StatistikenDashboardV21 } from './phase5000-statistiken-dashboard-v21';
...
// Phase 5140 — Statistiken-Dashboard V33 (Activity teal; Gesamt-Score+Ziel-Fortschrittsbalken; Alert-Strip; 9-KPI-Grid 3-spaltig Ampel+Icon+Δ+Ziel-Balken; 4-Tab-Nav Stunden/Fahrer/Zonen/Woche; Stunden-BarChart 3-Modi farbkodiert Jetzt-Stunde teal; Top-3-Fahrer Tier-Medaille+Score-Balken+Touren+Trinkgeld+Pünktl; Zonen-SLA-Kapazitäts-Balken+Avg+Umsatz; Wochen-LineChart+4-KPI-Summary; 60-Sek-Polling; Mock-Fallback)
export { LieferdienstPhase5140StatistikenDashboardV33 } from './phase5140-statistiken-dashboard-v33';
// Phase 5141 — Statistiken-Dashboard V34 (Activity teal; Gesamt-Score+Ziel-Fortschrittsbalken; 9-KPI-Grid 3-spaltig Ampel+Icon+Δ+Ziel-Balken; Alert-Strip; 4-Tab-Nav Stunden/Fahrer/Zonen/Woche; Stunden-BarChart 3-Modi Bestellungen/Umsatz/Pünktlichkeit; Top-3-Fahrer Tier-Medaille+Score-Balken+Trinkgeld+Pünktl; Zonen-SLA+AvgMin+Umsatz+Kapazitäts-Balken; Wochen-LineChart Heute-teal/Vorwoche-grau+Schicht-Kacheln; 60-Sek-Polling; Mock-Fallback)
export { LieferdienstPhase5141StatistikenDashboardV34 } from './phase5141-statistiken-dashboard-v34';
// Phase 5142 — Statistiken-Dashboard V35 (Activity teal; Gesamt-Score + Qualitäts-Score Dual-Fortschrittsbalken; 9-KPI-Grid 3-spaltig inkl. Qualitäts-Score; 5-Tab-Nav Stunden/Fahrer/Zonen/Woche/Alerts; Live-Alerts-Tab kritisch/warn/info mit Zeitstempel; km-heute je Fahrer; Wochen-LineChart; 60-Sek-Polling; Mock-Fallback)
...
// Phase 5145 — Statistiken-Dashboard V38 (Activity emerald; Dual-Gauge Effizienz+Qualität; 9-KPI-Grid 3-spaltig Ampel+Icon+Δ; 5-Tab-Nav Überblick/Stunden/Fahrer/Zonen/Prognose; Kapazitäts-Prognose vs. Bedarf BarChart; Fahrer-Tier+Trend-Icon; Zonen-SLA+Avg+Umsatz; Live-Alert-Feed; 60-Sek-Polling; Mock-Fallback)
...
// Phase 5531 — Statistiken-Dashboard V56 (Activity teal; V55+: Schichtstart-Pünktlichkeit-Trend TeamØ-Verzögerung je Stunde Ampel; Kundenbindungs-Kohorte Neukunde/Stammkunde/VIP-Anteil AreaChart; Tour-Qualitäts-Composite-Radar Pünktlichkeit/Bindung/Effizienz/Bewertung/Vollständigkeit; Schicht-Fairness-Index Auslastungs-Verteilung Gini; 17-KPI-Grid 4-spaltig; 12-Tab-Nav Überblick/Kapazität/Prognose/Ertrag/Zonen/Kosten/Kunden/Moral/Momentum/Perzentil/Pünktlichkeit/Qualität; 60s-Polling; Mock-Fallback)
