          ...
          <div className="h-32">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={stundeData} margin={{ top: 2, right: 2, left: -30, bottom: 0 }}>
                ...
                <Tooltip contentStyle={{ fontSize: 10 }} formatter={(v) => { const n = Number((v as number | string | undefined) ?? 0); return stundeMode === 'umsatz' ? `€${n}` : `${n}${stundeMode === 'pktl' ? '%' : ''}`; }} />
        ...
        <div className="h-40">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={data.woche} margin={{ top: 2, right: 2, left: -30, bottom: 0 }}>
              ...
              <Tooltip contentStyle={{ fontSize: 10 }} formatter={(v) => `€${Number((v as number | string | undefined) ?? 0)}`} />
