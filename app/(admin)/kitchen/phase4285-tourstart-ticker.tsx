...
export function KitchenPhase4285TourstartTicker({ locationId }: Props) {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-bold text-rose-600">
            Schnellster Start: {data.bester_name} — {bester?.avg_min} min
          </span>
        </div>
        <div className="flex items-center gap-1.5">
          ...
          {!loading && data.alert_count > 0 && (
            <span className="flex items-center gap-0.5 text-[10px] text-rose-600 font-semibold bg-rose-50 px-1.5 py-0.5 rounded-full">
