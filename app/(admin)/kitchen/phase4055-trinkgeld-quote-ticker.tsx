...
const MOCK: ApiData = {
  fahrer: [
    ...
    { fahrer_id: 'f3', fahrer_name: 'Sara K.',  rang: 2, trinkgeld_quote:  9, ampel: 'gruen', alert_bottom: false },
    { fahrer_id: 'f2', fahrer_name: 'Max M.',   rang: 3, trinkgeld_quote:  6, ampel: 'gelb',  alert_bottom: false },
...
export function KitchenPhase4055TrinkgeldQuoteTicker({ locationId }: Props) {
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-3 space-y-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-semibold text-gray-900">Trinkgeld</span>
        </div>
        <div className="flex items-center gap-1.5">
      ...
      <div className="flex justify-between text-[10px] text-gray-400 px-0.5 pt-0.5 border-t border-gray-100">
        <span>Ø {data.team_avg?.toFixed(1)} %</span>
        <span>#1 = höchste Trinkgeld-Quote</span>
      </div>
    </div>
  );
}
