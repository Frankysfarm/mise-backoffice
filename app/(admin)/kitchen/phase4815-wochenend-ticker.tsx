...
export function KitchenPhase4815WochenenTicker({ locationId }: { locationId: string | null }) {
  ...
  return (
    <div className="rounded-xl border border-violet-800 bg-violet-950/40 px-4 py-3 mb-3 flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-xs text-gray-400">Wochenend-Anteil — Champion</div>
        <div className="text-sm font-bold text-violet-300 truncate">
          #{top?.rang} {top?.fahrer_name} — {top?.wochenend_anteil_pct.toFixed(1)}% Wochenend-Schichten
        </div>
