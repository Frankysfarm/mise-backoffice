  ...
  return (
    <div className="rounded-2xl border border-indigo-200 dark:border-indigo-900 bg-white dark:bg-gray-900 p-3 space-y-2">
      <div className="flex items-center gap-1.5">
        <Moon className="w-4 h-4 text-indigo-900 dark:text-indigo-300" />
        <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">Donnerstagnacht-Ticker</span>
      </div>

      {top && (
        <div className="flex items-center gap-2">
          <span className="text-lg font-extrabold text-indigo-900 dark:text-indigo-300">#1</span>
          <span className="text-sm font-semibold text-gray-800 dark:text-gray-200 truncate">{top.fahrer_name}</span>
          <span className="ml-auto text-sm font-bold text-indigo-900 dark:text-indigo-300">{top.donnerstag_pct}%</span>
        </div>
      )}
