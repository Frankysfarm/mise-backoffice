...
// Phase 5653 — Feierabend-Effizienz-Trend-Ticker (Kitchen) — Batch 107
// Sunset orange-500; Beste/r #1 Name+Delta; Team-Trend; Rückfall-Alert; 30-Min-Polling; Mock-Fallback
...
export function KitchenPhase5653FeierabendEffizienzTrendTicker({ locationId }: { locationId: string | null }) {
    ...
    <div className="flex items-center gap-3 rounded-lg bg-gray-900 border border-orange-700/40 px-3 py-2">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-[10px] text-gray-500">
          Team-Trend {sign}{data.team_avg_delta.toFixed(2)} T/h · Feierabend-Effizienz (16–20h)
        </div>
      </div>
      {data.alert_count > 0 && (
