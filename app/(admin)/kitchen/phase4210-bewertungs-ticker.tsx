...
const MOCK: ApiData = {
  fahrer: [
    { fahrer_id: 'f1', fahrer_name: 'Sara K.',  rang: 1, score: 4.8, ampel: 'gruen', alert_bottom: false },
    { fahrer_id: 'f2', fahrer_name: 'Julia F.', rang: 2, score: 4.5, ampel: 'gruen', alert_bottom: false },
    { fahrer_id: 'f3', fahrer_name: 'Max M.',   rang: 3, score: 3.9, ampel: 'gelb',  alert_bottom: false },
    { fahrer_id: 'f4', fahrer_name: 'Tim B.',   rang: 4, score: 2.8, ampel: 'rot',   alert_bottom: true  },
  ],
  team_avg_score: 4.0,
  bester_name: 'Sara K.',
  alert_count: 1,
...
export function KitchenPhase4210BewertungsTicker({ locationId }: Props) {
