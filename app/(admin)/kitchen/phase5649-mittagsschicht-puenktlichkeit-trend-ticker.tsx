...
// Phase 5649 — Mittagsschicht-Pünktlichkeits-Trend-Ticker (Kitchen) — Batch 106
// Sun amber-400; Beste/r #1 Name+Delta; Team-Trend; Rückfall-Alert; 30-Min-Polling; Mock-Fallback
...
export function KitchenPhase5649MittagsschichtPuenktlichkeitsTrendTicker({ locationId }: { locationId: string | null }) {
    ...
    <div className="flex items-center gap-3 rounded-lg bg-gray-900 border border-amber-700/40 px-3 py-2">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-[10px] text-gray-500">
          Team-Trend {sign}{data.team_avg_delta.toFixed(1)}pp · Mittags-Pünktlichkeit (12–17h)
        </div>
      </div>
      {data.alert_count > 0 && (
