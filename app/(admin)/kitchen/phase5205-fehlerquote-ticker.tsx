...
export function KitchenPhase5205FehlerquoteTicker({ locationId }: { locationId: string | null }) {
  ...
  return (
    <div className="rounded-xl border border-red-700 bg-red-900/60 px-4 py-3 mb-3 flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-xs text-gray-400">Fehlerquote — Niedrigste</div>
        <div className="text-sm font-bold text-green-300 truncate">
          #{top.rang} {top.fahrer_name} — {top.reklamation_pct.toFixed(1)} %
        </div>
