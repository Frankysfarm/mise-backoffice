...
export function KitchenPhase4015LieferzeitTicker({ locationId }: Props) {
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-semibold text-gray-900">
          Lieferzeit
          {bester && (
            <span className="ml-1.5 text-emerald-600">#{bester.rang} {bester.fahrer_name} {bester.avg_min} min</span>
          )}
        </span>
