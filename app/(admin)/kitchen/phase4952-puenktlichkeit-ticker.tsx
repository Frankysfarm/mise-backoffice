  ...
  return (
    <div className="rounded-xl border border-green-700 bg-green-900/60 px-4 py-3 mb-3 flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-xs text-gray-400">Pünktlichkeit — Champion</div>
        <div className="text-sm font-bold text-green-100 truncate">
          #{top?.rang} {top?.fahrer_name} — {top?.pct_on_time} %
        </div>
        <div className="text-xs text-gray-500">Team-Ø: {data.team_avg} % · Ziel ≥90 %</div>
      </div>
      {data.alert_count > 0 && (
        <div className="flex items-center gap-1 text-xs text-green-300 shrink-0">
