...
const MOCK: ApiData = {
  fahrer: [
    { fahrer_id: 'f1', fahrer_name: 'Julia F.', rang: 1, avg_wartezeit_min:  3.2, trend_delta: -0.3, ampel: 'gruen' },
    { fahrer_id: 'f2', fahrer_name: 'Sara K.',  rang: 2, avg_wartezeit_min:  5.1, trend_delta:  0.2, ampel: 'gelb'  },
    { fahrer_id: 'f3', fahrer_name: 'Max M.',   rang: 3, avg_wartezeit_min:  7.8, trend_delta:  0.5, ampel: 'rot'   },
    { fahrer_id: 'f4', fahrer_name: 'Tim B.',   rang: 4, avg_wartezeit_min: 12.4, trend_delta:  1.3, ampel: 'rot'   },
  ],
  team_avg_wartezeit_min: 7.1,
  alert_count: 2,
};

export function KitchenPhase3867WartezeitProStoppTicker({ locationId }: { locationId: string | null }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-3 space-y-2">
      ...
      <div className="flex items-center justify-between">
        ...
        {best && (
          <div className="flex items-center gap-1 text-xs">
            ...
            <span className="font-black text-emerald-700">{best.avg_wartezeit_min} min</span>
          </div>
        )}
      </div>
      ...
      {/* Kompakt-Liste (aufsteigend: kürzeste = Rang 1 = bester) */}
