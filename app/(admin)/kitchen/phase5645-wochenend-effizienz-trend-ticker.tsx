...
// Phase 5645 — Wochenend-Effizienz-Trend-Ticker (Kitchen) — Batch 105
// Zap purple-400; Beste/r #1 Name+Delta; Team-Trend; Rückfall-Alert; 30-Min-Polling; Mock-Fallback
...
const MOCK: ApiResponse = {
  ...
  fahrer: [
    ...
    { rang: 2, effizienz_delta:  0.4, alert_rueckfall: false },
...
export function KitchenPhase5645WochenendEffizienzTrendTicker({ locationId }: { locationId: string | null }) {
    ...
    <div className="flex items-center gap-3 rounded-lg bg-gray-900 border border-purple-700/40 px-3 py-2">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-[10px] text-gray-500">
          Team-Trend {data.team_avg_delta > 0 ? '+' : ''}{data.team_avg_delta.toFixed(2)} T/h · Wochenend-Effizienz
        </div>
      </div>
      {data.alert_count > 0 && (
