...
export function KitchenPhase5250TrinkgeldProLieferungTicker({ locationId }: { locationId: string | null }) {
  ...
  return (
    <div className="rounded-xl border border-green-700 bg-green-900/60 px-4 py-3 mb-3 flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-xs text-gray-400">Trinkgeld/Lieferung — Meiste</div>
