...
const MOCK: ApiData = {
  fahrer: [
    { fahrer_id: 'f5', fahrer_name: 'Jana F.',  avg_sterne: 3.0, ampel: 'rot',   alert: true  },
    { fahrer_id: 'f2', fahrer_name: 'Sarah K.', avg_sterne: 3.2, ampel: 'rot',   alert: true  },
    { fahrer_id: 'f3', fahrer_name: 'Lena S.',  avg_sterne: 4.1, ampel: 'gelb',  alert: false },
    { fahrer_id: 'f1', fahrer_name: 'Max M.',   avg_sterne: 4.8, ampel: 'gruen', alert: false },
    { fahrer_id: 'f4', fahrer_name: 'Tom B.',   avg_sterne: 4.9, ampel: 'gruen', alert: false },
  ],
  team_avg_sterne: 4.0,
  alert_count: 2,
};

export function KitchenPhase2548BewertungsTicker({ locationId }: { locationId?: string | null }) {
    ...
    <div className={`rounded-xl border ${hasAlert ? 'border-red-200 bg-red-50' : 'border-gray-200 bg-white'} shadow-sm mb-3`}>
      ...
      >
        <div className="flex items-center gap-1.5">
          <Star size={14} className={hasAlert ? 'text-red-500' : 'text-amber-400'} />
          <span className="font-semibold text-xs text-gray-800">Bewertung</span>
          {hasAlert && (
