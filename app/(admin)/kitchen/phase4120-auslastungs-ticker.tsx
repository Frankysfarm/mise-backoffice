...
interface FahrerRow { fahrer_id: string; fahrer_name: string; rang: number; auslastung_pct: number; ampel: 'gruen' | 'gelb' | 'rot'; alert_bottom: boolean; }
...
export function KitchenPhase4120AuslastungsTicker({ locationId }: Props) {
