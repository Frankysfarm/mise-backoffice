...
export function KitchenPhase4875RegenzeitTicker({ locationId }: { locationId: string | null }) {
  ...
  return (
    <div className="rounded-xl border border-sky-700 bg-sky-900/60 px-4 py-3 mb-3 flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-xs text-gray-400">Regenzeit-Anteil — Champion</div>
        <div className="text-sm font-bold text-sky-100 truncate">
          #{top?.rang} {top?.fahrer_name} — {top?.regenzeit_anteil_pct.toFixed(1)}% Regenzeit-Touren
        </div>
