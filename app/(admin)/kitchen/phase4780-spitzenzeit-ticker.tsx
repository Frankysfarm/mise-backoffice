...
export function KitchenPhase4780SpitzenzeitTicker({ locationId }: { locationId: string | null }) {
  ...
  return (
    <div className="rounded-xl border border-orange-800 bg-orange-950/40 px-4 py-3 mb-3 flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-xs text-gray-400">Spitzenzeit — Effizientester Fahrer</div>
