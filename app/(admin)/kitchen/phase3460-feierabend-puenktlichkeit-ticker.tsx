...
export function KitchenPhase3460FeierabendPuenktlichkeitTicker({ locationId }: { locationId?: string | null }) {
    ...
    <div className="border rounded-lg bg-white dark:bg-gray-900 shadow-sm mb-2">
      ...
      >
        <span className="flex items-center gap-2 font-semibold text-xs">
          <LogOut className="w-3.5 h-3.5 text-teal-500" />
          Feierabend-Pünktlichkeit — Bester: {data.bester_name}
          {data.alert_count > 0 && (
