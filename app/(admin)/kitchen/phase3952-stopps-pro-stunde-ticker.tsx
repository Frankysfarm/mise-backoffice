...
export function KitchenPhase3952StoppsProStundeTicker({ locationId }: { locationId: string | null }) {
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-3 space-y-2">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-gray-900">Stopps/h</span>
        ...
        {best && (
          <div className="flex items-center gap-1 text-xs">
            ...
            <span className="font-black text-gray-700">{best.stopps_pro_stunde?.toFixed(1)}/h</span>
          </div>
        )}
      </div>
      ...
      {/* Kompakt-Liste (absteigend: meiste Stopps/h = Rang 1 = bester) */}
          ...
          return (
            <div key={f.fahrer_id} className="space-y-0.5">
              <div className="flex items-center gap-1.5 text-xs">
                ...
                <span className={`font-bold ${tColor}`}>{f.stopps_pro_stunde?.toFixed(1)}/h</span>
                {DeltaIcon}
              </div>
