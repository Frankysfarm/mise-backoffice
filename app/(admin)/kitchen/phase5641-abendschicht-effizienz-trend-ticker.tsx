...
// Phase 5641 — Abendschicht-Effizienz-Trend-Ticker (Kitchen) — Batch 104
// Moon blue-400; Beste/r #1 Name+Delta; Team-Trend; Rückfall-Alert; 30-Min-Polling; Mock-Fallback
...
export function KitchenPhase5641AbendschichtEffizienzTrendTicker({ locationId }: { locationId: string | null }) {
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg bg-gray-900 border border-blue-700/40 px-3 py-2">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-[10px] text-gray-500">
          Team-Trend {data.team_avg_delta > 0 ? '+' : ''}{data.team_avg_delta.toFixed(2)} T/h · Abendschicht-Effizienz
        </div>
      </div>
      {data.alert_count > 0 && (
