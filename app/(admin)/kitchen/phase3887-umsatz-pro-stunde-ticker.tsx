...
export function KitchenPhase3887UmsatzProStundeTicker({ locationId }: { locationId: string | null }) {
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-3 space-y-2">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-gray-900">Umsatz/Stunde</span>
        ...
        {best && (
          <div className="flex items-center gap-1 text-xs">
            ...
            <span className="font-black text-emerald-700">{best.umsatz_pro_stunde}€/h</span>
          </div>
        )}
      </div>
      ...
      {/* Kompakt-Liste (absteigend: höchster = Rang 1 = bester) */}
      ...
      <div className="flex items-center justify-between text-[10px] text-gray-400 border-t border-gray-100 pt-1.5">
        <span>Team-Ø {data.team_avg_umsatz}€/h</span>
        <span>Ziel ≥30€/h</span>
      </div>
    </div>
  );
