...
export function KitchenPhase5317KilometerTicker({ locationId }: { locationId: string | null }) {
  ...
  return (
    <div className="rounded-xl border border-green-700 bg-green-900/50 px-4 py-3 mb-3 flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-xs text-gray-400">Kilometer-Ranking — Meiste Strecke</div>
        ...
        <div className="text-[10px] text-gray-500 mt-0.5">
          ...
          {data.alert_count > 0 && (
            <span className="ml-2 text-green-400 inline-flex items-center gap-0.5">
