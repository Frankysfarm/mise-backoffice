...
const MOCK: ApiData = {
  fahrer: [
    { fahrer_id: 'f5', fahrer_name: 'Jana F.',  puenktlichkeit_pct: 57.1, ampel: 'rot',   alert: true  },
    { fahrer_id: 'f2', fahrer_name: 'Sarah K.', puenktlichkeit_pct: 66.7, ampel: 'rot',   alert: true  },
    { fahrer_id: 'f3', fahrer_name: 'Lena S.',  puenktlichkeit_pct: 81.8, ampel: 'gelb',  alert: false },
    { fahrer_id: 'f4', fahrer_name: 'Tom B.',   puenktlichkeit_pct: 92.3, ampel: 'gruen', alert: false },
    { fahrer_id: 'f1', fahrer_name: 'Max M.',   puenktlichkeit_pct: 94.4, ampel: 'gruen', alert: false },
  ],
  team_avg_pct: 78.5,
  alert_count: 2,
};

export function KitchenPhase2573PuenktlichkeitTicker({ locationId }: { locationId?: string | null }) {
    ...
    <div className={`rounded-xl border ${hasAlert ? 'border-red-200 bg-red-50' : 'border-gray-200 bg-white'} shadow-sm mb-3`}>
      ...
      >
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-semibold text-xs text-gray-800">Pünktlichkeit</span>
          {hasAlert && (
          ...
          {hasAlert && (
            <div className="flex items-start gap-1.5 bg-red-100 border border-red-200 rounded-lg px-2 py-1.5">
              ...
              <p className="text-xs text-red-700 font-medium">
                Pünktlichkeit &lt;75%: {alertFahrer.join(', ')}
              </p>
            </div>
          )}
