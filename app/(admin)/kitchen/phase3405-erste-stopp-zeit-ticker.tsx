...
export function KitchenPhase3405ErsteStoppZeitTicker({ locationId }: { locationId?: string | null }) {
    ...
    <div className="border rounded-lg bg-white dark:bg-gray-900 shadow-sm mb-2">
      ...
      >
        <span className="flex items-center gap-2 font-semibold text-xs">
          <TimerReset className="w-3.5 h-3.5 text-yellow-500" />
          Erste-Stopp-Zeit — Schnellster: {data.schnellster_name}
          {data.alert_count > 0 && (
