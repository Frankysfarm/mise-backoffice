...
export function KitchenPhase4621MontagNachtTicker({ locationId }: { locationId: string | null }) {
  ...
  if (error) {
    return (
      <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-3 flex items-center gap-2 text-gray-400">
        ...
        <span className="text-xs">Montagnacht-Ticker nicht verfügbar</span>
      </div>
    );
  }
  ...
  return (
    <div className="rounded-2xl border border-indigo-200 dark:border-indigo-900 bg-white dark:bg-gray-900 p-3 space-y-2">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">Montagnacht-Ticker</span>
      </div>
      ...
      {top && (
        <div className="flex items-center gap-2">
          ...
          <span className="ml-auto text-sm font-bold text-indigo-900 dark:text-indigo-300">{top.montag_pct}%</span>
        </div>
      )}
