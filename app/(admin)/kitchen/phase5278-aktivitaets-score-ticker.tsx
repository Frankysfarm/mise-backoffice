...
export function KitchenPhase5278AktivitaetsScoreTicker({ locationId }: { locationId: string | null }) {
  ...
  return (
    <div className="rounded-xl border border-violet-700 bg-violet-900/60 px-4 py-3 mb-3 flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-xs text-gray-400">Aktivitätsscore — Aktivste</div>
        <div className="text-sm font-bold text-violet-100 truncate">
          #{top.rang} {top.fahrer_name} — Score {top.aktivitaets_score}
        </div>
