    ...
    <div className="bg-white rounded-xl border border-gray-200 p-3 space-y-2">
      ...
      <div className="flex items-center justify-between">
        ...
        {best && (
          <div className="flex items-center gap-1 text-xs">
            ...
            <span className="font-black text-blue-700">{best.avg_kmh} km/h</span>
          </div>
        )}
      </div>
      ...
      <div className="space-y-1.5">
        {data.fahrer.map(f => {
          ...
          const tColor = f.ampel === 'gruen' ? 'text-blue-700' : f.ampel === 'gelb' ? 'text-yellow-600' : 'text-gray-500';
          const barColor = f.ampel === 'gruen' ? 'bg-blue-500' : f.ampel === 'gelb' ? 'bg-yellow-400' : 'bg-gray-400';
          return (
