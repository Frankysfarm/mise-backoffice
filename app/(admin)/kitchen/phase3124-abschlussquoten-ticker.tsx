...
export function KitchenPhase3124AbschlussquotenTicker({ locationId }: { locationId?: string | null }) {
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-sm text-gray-800 dark:text-gray-100">
            Abschlussquote · #1 {bester?.fahrer_name ?? data?.bester_name ?? '—'} ({bester ? `${bester.quote_pct}%` : '—'})
          </span>
            ...
            {list.map(f => (
              <div key={f.fahrer_id} className="flex items-center justify-between text-xs py-1 border-b border-gray-100 dark:border-gray-800 last:border-0">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="font-semibold text-gray-700 dark:text-gray-200">{f.quote_pct}%</span>
