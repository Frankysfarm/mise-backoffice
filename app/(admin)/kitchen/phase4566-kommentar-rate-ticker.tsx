...
export function KitchenPhase4566KommentarRateTicker({ locationId }: Props) {
  ...
  return (
    <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-3">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">Kommentar-Rate</span>
        {data.alert_count > 0 && (
