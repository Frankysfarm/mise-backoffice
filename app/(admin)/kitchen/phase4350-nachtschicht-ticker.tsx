...
export function KitchenPhase4350NachtschichtTicker({ locationId }: Props) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-3 space-y-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-bold text-purple-600">
            Nacht-König: {data.meister_name} — {meister?.nacht_anteil_pct.toFixed(1)} %
          </span>
        </div>
        <div className="flex items-center gap-1.5">
      ...
      <div className="flex items-center justify-between text-[10px] text-gray-400 pt-0.5 border-t border-gray-100">
        ...
        <span>#1 = höchster Nachtanteil (22–06 Uhr)</span>
      </div>
    </div>
  );
}
