  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md text-center">
        ...
        {/* Phase 395: ETA-Detail-Karte — Vollständige Tracking-Karte mit Konfidenz-Ring, Countdown, Fahrer-Info */}
        {isDelivery && orderId && (
          <EtaDetailKarte orderId={orderId} initialEtaMin={etaMinutes} initialStatus={null} />
        )}
        ...
        {/* Phase 369: ETA-Verlauf-Timeline — Vertikale 5-Phasen-Timeline mit Zeitstempeln + Supabase Realtime */}
        {isDelivery && orderId && (
        ...
        {isDelivery && orderId && (
          <div className="mt-3 w-full">
            <BestellungLiveVerfolgung
              orderId={orderId}
              bestellnummer={bestellnummer}
              status={liveStatus as any}
              etaMin={etaMinutes || null}
              driverName={driverName}
              bestelltAm={null}
              className="w-full"
            />
