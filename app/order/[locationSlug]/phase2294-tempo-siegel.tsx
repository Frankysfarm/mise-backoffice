...
export function StorefrontPhase2294TempoSiegel({
  locationId,
  className,
}: {
  locationId: string;
  ...
  if (!mounted || !data || data.team_avg_bph < 4) return null;
  ...
  return (
    ...
    >
      ...
      Blitzschnell — {data.team_avg_bph.toFixed(1)} Bestellungen/Std
    </div>
  );
}
