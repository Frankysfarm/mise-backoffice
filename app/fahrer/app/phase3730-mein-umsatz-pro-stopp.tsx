...
const COACHING: Record<string, string> = {
  gruen: 'Top-Umsatz pro Stopp! Du nimmst hochwertige Bestellungen an.',
  gelb: 'Solider Umsatz. Versuche größere Bestellungen zu priorisieren.',
  rot: 'Umsatz pro Stopp zu niedrig. Besprich Tourenplanung mit Dispatch.',
};

export function FahrerPhase3730MeinUmsatzProStopp({
  driverId,
  locationId,
  isOnline,
}: {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-gray-900">Mein Umsatz pro Stopp</h3>
      </div>

      <div className="flex items-end gap-4">
        <span className={`text-5xl font-black tabular-nums ${AMPEL_TEXT[me.ampel]}`}>
          {me.avg_euro}<span className="text-2xl font-bold ml-1">€</span>
        </span>
