...
export function FahrerPhase4328MeineLieferzeit({ driverId, locationId, isOnline }: Props) {
  ...
  const coaching =
    me.ampel === 'gruen'
      ? 'Super! Du gehörst zu den schnellsten Fahrern — Kunden warten nicht gern.'
      : me.ampel === 'gelb'
      ? 'Tipp: Effiziente Routenplanung und zügige Übergaben helfen, die Lieferzeit zu verkürzen.'
      : 'Achtung: Deine Ø-Lieferzeit liegt deutlich über dem Teamdurchschnitt.';
    ...
    <div className={`rounded-2xl border p-4 space-y-3 ${ampelBg} border-gray-200`}>
      ...
      <div className="flex items-end gap-3">
        ...
        <div className="pb-1 space-y-0.5">
          <span className="text-sm text-gray-500">min Ø-Lieferzeit</span>
