...
const COACHING: Record<string, string> = {
  gruen: 'Top-Abdeckung! Du kennst viele Gebiete.',
  gelb: 'Solide — neue Zonen erschließen steigert deinen Rang.',
  rot: 'Geringe Abdeckung — probiere neue Liefergebiete aus.',
};

export function FahrerPhase3675MeineAbdeckung({
  driverId,
  locationId,
  isOnline,
}: {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-gray-900">Meine Abdeckung</h3>
      </div>
      ...
      <div className="flex items-end gap-4">
        ...
        <div className="flex flex-col mb-1">
          <span className="text-xs text-gray-400">Zonen</span>
