...
export function FahrerPhase4423MeinePuenktlichkeit({ driverId, locationId, isOnline }: Props) {
  ...
  const coaching =
    me.ampel === 'gruen'
      ? 'Top-Pünktlichkeit! Du lieferst zuverlässig pünktlich. Kunden schätzen das sehr.'
      : me.ampel === 'gelb'
      ? 'Solide Pünktlichkeit. Mit besserer Routenplanung kannst du noch pünktlicher werden.'
      : 'Tipp: Deine Pünktlichkeitsquote ist zu niedrig. Plane Pufferzeit ein und informiere Kunden proaktiv bei Verzögerungen.';
  ...
  return (
    <div className={`rounded-2xl border p-4 space-y-3 ${ampelBg} border-gray-200`}>
      ...
      <div className="flex items-end gap-3">
        <span className={`text-5xl font-extrabold ${ampelColor}`}>{me.rate_pct}</span>
        <div className="pb-1 space-y-0.5">
          <span className="text-sm text-gray-500">% pünktlich (30 Tage)</span>
