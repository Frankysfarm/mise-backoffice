...
export function FahrerPhase4002MeineSchichtstartPuenktlichkeit({ driverId, locationId, isOnline }: Props) {
  ...
  const coaching =
    me?.ampel === 'gruen'
      ? 'Top – deine Schichtstartpünktlichkeit ist ausgezeichnet!'
      : me?.ampel === 'gelb'
      ? 'Tipp: Versuche deinen Schicht pünktlich zu beginnen.'
      : 'Achtung: Deine Pünktlichkeitsquote ist zu niedrig.';
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      ...
      <div className="flex items-end justify-center gap-3 py-2">
        <div className="text-center">
          <div className={`text-5xl font-black ${rateColor}`}>{me?.puenktlichkeit_pct}%</div>
          <div className="flex items-center justify-center gap-1 mt-1">
            {DeltaIcon}
            <span className="text-xs text-gray-400">Pünktlichkeit (30 Tage)</span>
          </div>
        </div>
