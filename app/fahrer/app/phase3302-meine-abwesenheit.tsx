...
import { CalendarX, AlertTriangle, ChevronDown, ChevronUp, TrendingUp, TrendingDown, Minus } from 'lucide-react';
...
function coachingTipp(a: string): string {
  if (a === 'rot')  return 'Hohe Abwesenheit! Versuche, geplante Schichten zuverlässiger einzuhalten — dein Team zählt auf dich.';
  if (a === 'gelb') return 'Gute Zuverlässigkeit! Weniger als 2 Fehltage in 30 Tagen ist das Ziel für die grüne Zone.';
  return 'Ausgezeichnete Zuverlässigkeit! Du bist einer der verlässlichsten Fahrer im Team.';
}

export function FahrerPhase3302MeineAbwesenheit({
  driverId,
  locationId,
  isOnline,
}: {
    ...
    <div className="rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm mb-4 overflow-hidden bg-white dark:bg-gray-900">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-sm text-gray-800 dark:text-gray-100">Meine Abwesenheit</span>
        ...
        <div className="p-4 space-y-4">
          <div className={`rounded-xl p-4 text-center ${cls.bg}`}>
            <div className={`text-5xl font-black ${cls.text}`}>
              {me.tage}<span className="text-2xl font-semibold"> Tage</span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            ...
            <div className="rounded-lg bg-gray-50 dark:bg-gray-800 p-2 text-center">
              ...
              <div className="font-bold text-sm text-blue-600 dark:text-blue-400">{d.team_avg_tage} Tage</div>
            </div>
          </div>
