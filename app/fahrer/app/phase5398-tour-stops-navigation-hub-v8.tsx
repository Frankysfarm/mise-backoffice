...
const MOCK: TourData = {
  ...
  stops: [
    ...
    { id: 's4', nr: 4, adresse: 'Boxgraben 22, Aachen',       lat: 50.7699, lng: 6.0805, kundename: 'Tom B.',    telefon: '+49170XXXX', status: 'aktiv',          eta_min: 4, eta_konfidenz_pct: 88, entfernung_km: 1.5, zahlung: 'online', betrag_eur: 31.20, trinkgeld_eur: 0, ki_reihenfolge: 4, notiz: null, bewertung: null },
    { id: 's5', nr: 5, adresse: 'Heinrichsallee 5, Aachen',   lat: 50.7720, lng: 6.0930, kundename: 'Nina L.',   telefon: null,          status: 'ausstehend',     eta_min: 12, eta_konfidenz_pct: 74, entfernung_km: 2.1, zahlung: 'karte',  betrag_eur: 18.90, trinkgeld_eur: 0, ki_reihenfolge: 5, notiz: null, bewertung: null },
  ],
};
