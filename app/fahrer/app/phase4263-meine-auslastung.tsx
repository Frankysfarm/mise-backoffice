...
export function FahrerPhase4263MeineAuslastung({ driverId, locationId, isOnline }: Props) {
  ...
  const coaching =
    me.ampel === 'gruen'
      ? 'Super! Du nutzt deine Schichtzeit sehr effizient.'
      : me.ampel === 'gelb'
      ? 'Tipp: Reduziere Leerlaufzeiten für eine bessere Auslastung.'
  ...
  return (
    <div className={`rounded-2xl border p-4 space-y-3 ${ampelBg} border-gray-200`}>
      ...
      <div className="flex items-end gap-3">
        <span className={`text-5xl font-extrabold ${ampelColor}`}>{me.auslastung_pct}%</span>
