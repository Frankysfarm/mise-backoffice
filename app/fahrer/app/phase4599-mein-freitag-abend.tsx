...
function coaching(pct: number): string {
  if (pct >= 65) return 'Stark! Du deckst den Freitagabend sehr gut ab.';
  if (pct >= 30) return 'Gut! Freitagabend ist eine der umsatzstärksten Zeiten.';
  return 'Wenig Freitagabend-Touren — Freitag 17–22 Uhr ist sehr gefragt!';
}
