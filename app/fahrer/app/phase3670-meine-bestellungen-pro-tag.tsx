...
const COACHING: Record<string, string> = {
  gruen: 'Top-Leistung! Weiter so.',
  gelb: 'Solide — ein paar mehr Bestellungen/Tag sind möglich.',
  rot: 'Wenige Bestellungen/Tag — Verfügbarkeit prüfen.',
};

export function FahrerPhase3670MeineBestellungenProTag({
  driverId,
  locationId,
  isOnline,
}: {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-gray-900">Meine Bestellungen/Tag</h3>
      </div>

      <div className="flex items-end gap-4">
        <span className={`text-5xl font-black ${AMPEL_COLOR[ich.ampel]}`}>
          {ich.bestellungen_pro_tag.toFixed(1)}
        </span>
