...
const COACHING: Record<string, string> = {
  gruen: 'Top-Effizienz! Du fährst überdurchschnittlich viele Touren pro Schicht.',
  gelb: 'Solide Leistung. Kürzere Pausen zwischen Touren können helfen.',
  rot: 'Wenige Touren pro Schicht. Besprich die Tourenplanung mit Dispatch.',
};

export function FahrerPhase3735MeineTourenProSchicht({
  driverId,
  locationId,
  isOnline,
}: {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-gray-900">Meine Touren pro Schicht</h3>
      </div>

      <div className="flex items-end gap-4">
        <span className={`text-5xl font-black tabular-nums ${AMPEL_TEXT[me.ampel]}`}>
          {me.touren_pro_schicht}
        </span>
