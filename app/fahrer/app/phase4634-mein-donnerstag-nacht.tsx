...
function coaching(pct: number): string {
  if (pct >= 30) return 'Top! Du bist oft donnerstagnachts dabei.';
  if (pct >= 15) return 'Gut! Donnerstagnacht-Anteil im Bereich.';
...
export function FahrerPhase4634MeinDonnerstagNacht({
  ...
  return (
    <div className="rounded-2xl border border-blue-200 dark:border-blue-900 bg-white dark:bg-gray-900 p-4 space-y-3">
      ...
      <div className="flex items-end gap-4">
        <span className="text-5xl font-extrabold text-blue-700 dark:text-blue-400">{data.pct}%</span>
        <div className="pb-1">
