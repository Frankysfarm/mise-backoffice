...
const COACHING: Record<string, string> = {
  gruen: 'Top-Trinkgeld-Quote! Kunden sind sehr zufrieden mit dir — weiter so.',
  gelb: 'Solide Quote. Freundlicher Service und schnelle Lieferung bringen dich in die Spitzengruppe.',
  rot: 'Niedrige Trinkgeld-Quote. Freundlichkeit, Pünktlichkeit und ein Lächeln an der Tür helfen.',
};

export function FahrerPhase3690MeineTrinkgeldQuote({
  driverId,
  locationId,
  isOnline,
}: {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-gray-900">Meine Trinkgeld-Quote</h3>
      </div>

      <div className="text-center space-y-1">
        <div className={`text-5xl font-black ${me.ampel === 'gruen' ? 'text-emerald-600' : me.ampel === 'gelb' ? 'text-yellow-600' : 'text-red-600'}`}>
          {me.trinkgeld_quote.toFixed(1)}%
        </div>
        <div className="text-sm text-gray-500">Trinkgeld / Bestellwert</div>
