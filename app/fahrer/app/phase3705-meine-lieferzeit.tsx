...
const COACHING: Record<string, string> = {
  gruen: 'Top-Lieferzeit! Du bist einer der schnellsten im Team.',
  gelb: 'Solide Lieferzeit. Optimiere deine Route für mehr Tempo.',
  rot: 'Deine Lieferzeit ist zu hoch. Prüfe deine Stoppreihenfolge.',
};

export function FahrerPhase3705MeineLieferzeit({
  driverId,
  locationId,
  isOnline,
}: {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-gray-900">Meine Ø Lieferzeit</h3>
      </div>

      <div className="flex items-end gap-4">
        <span className={`text-5xl font-black tabular-nums ${AMPEL_TEXT[me.ampel]}`}>
          {me.avg_minuten}<span className="text-2xl font-bold ml-1">min</span>
        </span>
