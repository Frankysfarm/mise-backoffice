...
const COACHING: Record<string, string> = {
  gruen: 'Niedrige Storno-Quote! Du absolvierst fast alle Touren erfolgreich — weiter so!',
  gelb: 'Mittlere Storno-Quote. Mit weniger Stornierungen kommst du in die Top-25%.',
  rot: 'Hohe Storno-Quote. Bitte Ursachen klären und mit dem Dispatcher sprechen.',
};

export function FahrerPhase3605MeineStornoQuote({
  driverId,
  locationId,
  isOnline,
}: {
