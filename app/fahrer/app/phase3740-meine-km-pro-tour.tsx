...
const COACHING: Record<string, string> = {
  gruen: 'Top-Effizienz! Du fährst die kürzesten Routen im Team.',
  gelb: 'Solide Leistung. Optimierte Routen können die km pro Tour senken.',
  rot: 'Hohe km pro Tour. Sprich die Routenplanung mit Dispatch durch.',
};
...
export function FahrerPhase3740MeineKmProTour({
  ...
  // Rang 1 = wenigste km = bester — Balken links=gut, rechts=schlecht
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-gray-900">Meine km pro Tour</h3>
      </div>
      ...
      <div className="flex items-end gap-4">
        ...
        <div className="flex flex-col items-start">
          <span className="text-lg font-semibold text-gray-500">km</span>
