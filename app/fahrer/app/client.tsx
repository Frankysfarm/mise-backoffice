...
import { Banknote, Bike, Calendar, Check, ChevronDown, ChevronUp, Clock, FileText, History, Loader2, LogOut, MapPin, Navigation, Package, Phone, Power, Receipt, Route, ShoppingBag, TrendingUp, Trophy, Zap, ListOrdered } from 'lucide-react';
...
import { CANONICAL_OFFER_STORAGE_KEY, applySuccessfulClientTransition, integrateCanonicalOffer, parseCanonicalOffer, prepareClientTransition, type CanonicalClientOffer, type ClientOfferAction } from './atomic-offer-client-state';
...
import { type TagesabschlussData } from './tagesabschluss-badge';
      ...
      <main className="px-4 py-6 space-y-5">
        ...
        {activeBatch && activeBatch.status === 'unterwegs' && (
          <DeliveryView
            ...
            stops={[...activeBatch.stops].sort((a, b) =>
              (a.reihenfolge ?? Number.MAX_SAFE_INTEGER) - (b.reihenfolge ?? Number.MAX_SAFE_INTEGER)) as any}
        ...
        {activeBatch && activeBatch.status !== 'unterwegs' && (
          <section>
            ...
            {/* Tour-Stopp-Übersicht vor dem Packen — Navigation startet erst in DeliveryView. */}
