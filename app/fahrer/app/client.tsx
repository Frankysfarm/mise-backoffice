...
import { FahrerPhase4946MeinePuenktlichkeit } from './phase4946-meine-puenktlichkeit';
    ...
    <div className="min-h-screen pb-24">
      ...
      <main className="px-4 py-6 space-y-5">
        ...
        <div className="px-4">
          ...
          <FahrerPhase4946MeinePuenktlichkeit driverId={driver.id} locationId={driver.location_id ?? null} isOnline={isOnline} />
...
export { FahrerPhase4946MeinePuenktlichkeit } from './phase4946-meine-puenktlichkeit';
