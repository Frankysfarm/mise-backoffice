...
import { FahrerPhase4118MeineReaktionszeit } from './phase4118-meine-reaktionszeit';
    ...
    <div className="min-h-screen pb-24">
      ...
      <main className="px-4 py-6 space-y-5">
        ...
        <div className="px-4">
          ...
          <FahrerPhase4118MeineReaktionszeit driverId={driver.id} locationId={driver.location_id ?? null} isOnline={isOnline} />
...
// Phase 4118 — Meine Reaktionszeit (Timer cyan; avg_min 5xl+Rang 2xl farbkodiert; Ziel <5 min; Coaching-Tipp; isOnline-Guard; rank_delta<0=gruen; 30-Min-Polling)
export { FahrerPhase4118MeineReaktionszeit } from './phase4118-meine-reaktionszeit';
