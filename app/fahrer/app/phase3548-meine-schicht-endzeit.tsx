...
const COACHING: Record<string, string> = {
  gruen: 'Pünktliches Schichtende — top Einsatz!',
  gelb: 'Gutes Schichtende — ein bisschen früher wäre ideal.',
  rot: 'Späte Schichtenden belasten dich. Versuche pünktlicher zu enden.',
};
...
export function FahrerPhase3548MeineSchichtEndzeit({
  driverId,
  locationId,
  isOnline,
}: {
  ...
  return (
    <div className="rounded-xl border bg-white shadow-sm p-4 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <span className="font-semibold text-gray-800">Meine Schicht-Endzeit</span>
      </div>
