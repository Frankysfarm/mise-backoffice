...
const COACHING: Record<string, string> = {
  gruen: 'Top-Wartezeit! Deine Wartezeit/Stopp liegt unter dem Teamziel — weiter so.',
  gelb: 'Solide. Etwas schnellere Stops bringen dich in die Spitzengruppe.',
  rot: 'Hohe Wartezeit/Stopp! Effizientere Abläufe beim Kunden helfen dir, den Wert zu senken.',
};

export function FahrerPhase3680MeineWartezeitProStopp({
  driverId,
  locationId,
  isOnline,
}: {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-gray-900">Meine Wartezeit/Stopp</h3>
      </div>

      <div className="text-center space-y-1">
        <div className={`text-5xl font-black ${me.ampel === 'gruen' ? 'text-emerald-600' : me.ampel === 'gelb' ? 'text-yellow-600' : 'text-red-600'}`}>
          {me.wartezeit_min.toFixed(1)}
        </div>
        <div className="text-sm text-gray-500">Minuten pro Stopp</div>
