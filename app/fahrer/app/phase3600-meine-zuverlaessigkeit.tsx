...
const COACHING: Record<string, string> = {
  gruen: 'Top-Zuverlässigkeit! Du lieferst fast immer pünktlich — weiter so!',
  gelb: 'Gute Zuverlässigkeit. Mit noch mehr Pünktlichkeit kommst du in die Top-25%.',
  rot: 'Niedrige Zuverlässigkeit. Bitte auf ETA-Einhaltung achten — sprich mit deinem Dispatcher.',
};

export function FahrerPhase3600MeineZuverlaessigkeit({
  driverId,
  locationId,
  isOnline,
}: {
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      ...
      <div className="space-y-1">
        <div className="flex justify-between text-xs text-gray-500">
          <span>Zuverlässigkeits-Rang</span>
