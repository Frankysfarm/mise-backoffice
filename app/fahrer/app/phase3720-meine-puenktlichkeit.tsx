...
const COACHING: Record<string, string> = {
  gruen: 'Hervorragende Pünktlichkeit! Bleib auf diesem Niveau.',
  gelb: 'Solide Pünktlichkeit. Optimierte Routen helfen dir, noch pünktlicher zu sein.',
  rot: 'Pünktlichkeit zu niedrig. Plane mehr Pufferzeit ein und informiere Kunden bei Verzögerungen.',
};

export function FahrerPhase3720MeinePuenktlichkeit({
  driverId,
  locationId,
  isOnline,
}: {
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      ...
      <div className="flex items-end gap-4">
        <span className={`text-5xl font-black tabular-nums ${AMPEL_TEXT[me.ampel]}`}>
          {me.rate_pct}<span className="text-2xl font-bold ml-1">%</span>
        </span>
