...
const COACHING_TIP: Record<string, string> = {
  gruen: 'Top! Du optimierst deine Stopps sehr effizient — kurze Abstände, hohe Leistung.',
  gelb: 'Gut — versuche Stopps enger zu bündeln, um deine km/Stopp-Quote weiter zu senken.',
  rot: 'Tipp: Sprich mit dem Dispatcher — optimierte Tourbündelung kann deine km/Stopp deutlich senken.',
};

export function FahrerPhase3518MeineKmProStopp({
  driverId,
  locationId,
  isOnline,
}: {
  ...
  const load = useCallback(async () => {
    ...
    try {
      const r = await fetch(
        `/api/delivery/admin/fahrer-km-pro-stopp?location_id=${locationId}&driver_id=${driverId}`,
        { cache: 'no-store' }
      );
      if (!r.ok) return;
        ...
        <div className="px-4 pb-4 space-y-3">
          <div className="flex items-end justify-center gap-4">
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500 mt-0.5">km/Stopp</div>
            </div>
            <div className="text-center">
