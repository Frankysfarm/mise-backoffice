  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: 14 }}>
        <div style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: 16, padding: 22, boxShadow: '0 1px 2px rgba(15,23,42,.05)' }}><div style={{ fontSize: 13, fontWeight: 700, color: '#047857', background: '#ECFDF5', borderRadius: 6, padding: '2px 8px', display: 'inline-block' }}>7 % USt (Speisen)</div><div style={{ fontFamily: "'Space Grotesk'", fontSize: 26, fontWeight: 700, marginTop: 12 }}>{eur(b7)}</div><div style={{ fontSize: 13, color: '#64748B', marginTop: 2 }}>davon USt: {eur(tax7)}</div></div>
        <div style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: 16, padding: 22, boxShadow: '0 1px 2px rgba(15,23,42,.05)' }}><div style={{ fontSize: 13, fontWeight: 700, color: '#1D4ED8', background: '#EFF6FF', borderRadius: 6, padding: '2px 8px', display: 'inline-block' }}>19 % USt (Getränke/vor Ort)</div><div style={{ fontFamily: "'Space Grotesk'", fontSize: 26, fontWeight: 700, marginTop: 12 }}>{eur(b19)}</div><div style={{ fontSize: 13, color: '#64748B', marginTop: 2 }}>davon USt: {eur(tax19)}</div></div>
      </div>
      <div style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: 16, padding: 22, boxShadow: '0 1px 2px rgba(15,23,42,.05)' }}>
        <h3 style={{ fontFamily: "'Space Grotesk'", fontSize: 16, fontWeight: 700, marginBottom: 14 }}>Export (letzte 30 Tage)</h3>
