...
const MODULES = [
  ...
  {
    title: 'Verantwortung & Team',
    description: 'Pflichtbereiche, Organigramm, Verantwortungen, Aufgaben, Kontrollen und Vertretungen zentral steuern.',
    href: '/neo/app/mitarbeiter',
    action: 'Team organisieren',
    badge: 'NEO',
    color: '#4F46E5',
    tint: '#EEF2FF',
    icon: UsersRound,
  ...
  {
    title: 'Dienstplan',
    description: 'Schichten, Bereiche, Qualifikationen, Vorlagen und offene Besetzungen zentral planen.',
    href: '/neo/app/dienstplan',
    action: 'Dienstplan öffnen',
    badge: 'ZENTRAL',
    color: '#4F46E5',
    tint: '#EEF2FF',
    icon: CalendarDays,
  ...
  {
    title: 'Lager',
    description: 'Lagerorte, Bestände, Inventuren, Wareneingang und HACCP zentral steuern.',
    href: '/neo/app/lager',
    action: 'Lager öffnen',
    badge: 'ZENTRAL',
    color: '#4F46E5',
  ...
  {
    title: 'Listen & Abläufe',
    description: 'Reinigung, Öffnung, Schließung und wiederkehrende Betriebsabläufe verbindlich bauen.',
    href: '/neo/app/ablaeufe',
    action: 'Abläufe öffnen',
    badge: 'ZENTRAL',
    color: '#4F46E5',
    tint: '#EEF2FF',
    icon: ListChecks,
  ...
  {
    title: 'Schulungen',
    description: 'Lektionen, Quiz, Praxisabnahmen, Zertifikate und Onboarding zentral verwalten.',
    href: '/neo/app/schulungen',
    action: 'Schulungen öffnen',
    badge: 'ZENTRAL',
    color: '#4F46E5',
    tint: '#EEF2FF',
    icon: GraduationCap,
  ...
  },
  {
    ...
    description: 'Pflichtnachweise, Zertifikate und Qualifikationssperren zuverlässig im Blick behalten.',
    href: '/neo/app/compliance',
    action: 'Compliance öffnen',
    badge: 'ZENTRAL',
    color: '#4F46E5',
    tint: '#EEF2FF',
    icon: ShieldCheck,
  ...
  {
    title: 'Rezeptbuch',
    description: 'Rezepte, Arbeitsschritte, Allergene und Küchenwissen als gemeinsame Quelle pflegen.',
    href: '/neo/app/rezeptbuch',
    action: 'Rezeptbuch öffnen',
    badge: 'ZENTRAL',
    color: '#4F46E5',
    tint: '#EEF2FF',
    icon: BookOpen,
