...
import { ArrowRight, BriefcaseBusiness, MonitorDot, QrCode, ReceiptText } from 'lucide-react';
...
export default function NeoModuleDashboard() {
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#F1F5F9', color: '#0F172A', fontFamily: "'Plus Jakarta Sans',system-ui,sans-serif" }}>
        <header style={{ height: 64, display: 'flex', alignItems: 'center', padding: '0 26px', background: '#fff', borderBottom: '1px solid #E2E8F0' }}>
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 9, color: '#64748B', fontSize: 12.5, fontWeight: 650 }}><span style={{ width: 7, height: 7, borderRadius: '50%', background: '#6366F1' }} />4 Module verbunden</div>
        </header>
        ...
        <main style={{ width: 'min(1040px,calc(100% - 40px))', margin: '0 auto', padding: '54px 0 70px' }}>
          <div style={{ marginBottom: 28 }}>
            ...
            <p style={{ marginTop: 9, color: '#64748B', fontSize: 14.5 }}>Vier Module, ein Betrieb. Wähle den Bereich, in dem du jetzt arbeiten möchtest.</p>
          </div>
