...
const MODULES = [
  ...
  {
    title: 'Mitarbeiter',
    description: 'Das fertige Mise-OS-Team: Bereiche, Rollen, Verfügbarkeiten und Mitarbeiter verwalten.',
    href: '/neo/os/bereiche',
    action: 'Mise OS öffnen',
    badge: 'MISE OS',
    color: '#E68A2C',
    tint: '#FFF3E8',
    icon: UsersRound,
  ...
  {
    title: 'Dienstplan',
    description: 'Der ausgebaute Mise-OS-Dienstplan mit Bereichen, Qualifikationen und offenen Schichten.',
    href: '/neo/os/dienstplan',
    action: 'Mise OS öffnen',
    badge: 'MISE OS',
    color: '#E68A2C',
    tint: '#FFF3E8',
  ...
  {
    title: 'Lager',
    description: 'Lagerorte, Bestände, Inventuren, Wareneingang und HACCP in Mise OS steuern.',
    href: '/neo/os/lager',
    action: 'Mise OS öffnen',
    badge: 'MISE OS',
    color: '#E68A2C',
